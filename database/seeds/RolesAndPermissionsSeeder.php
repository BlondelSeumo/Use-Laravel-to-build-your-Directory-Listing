...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function initVendor(){
        ...
        $vendor->givePermissionTo('property_view');
        $vendor->givePermissionTo('property_create');
        $vendor->givePermissionTo('property_update');
        $vendor->givePermissionTo('property_delete');
    }
}
