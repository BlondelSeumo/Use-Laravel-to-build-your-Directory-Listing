<div class="row">
    ...
    <div class="col-sm-8">
        ...
        <div class="panel">
            <div class="panel-title"><strong>{{__('Background Options')}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <label><strong>{{__("Background")}}</strong></label>
                    <div class="form-controls">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-controls form-group-image form-group-image-white">
                                        {!! \Modules\Media\Helpers\FileHelper::fieldUpload('footer_bg_id',$settings['footer_bg_id'] ?? '') !!}
                                    </div>
                                </div>
                            </div>
                        </div>
