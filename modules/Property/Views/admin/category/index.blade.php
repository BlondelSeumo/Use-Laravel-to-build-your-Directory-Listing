                        ...
                        <form class="bc-form-item">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="thumbnail d-none d-md-table-cell" style="width: 100px">{{__("Thumbnail")}}</th>
                                    <th>{{__("Name")}}</th>
                                ...
                                @if( count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-md-table-cell">
                                            @if($row->image_id)
                                                <img src="{{ \Modules\Media\Helpers\FileHelper::url($row->image_id, 'thumb') }}" alt="{{$row->slug}}" />
                                            @endif
                                        </td>
                                        <td class="title">
