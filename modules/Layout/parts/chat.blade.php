    ...
    <div v-else class="chat-maximum">
        ...
        <div class="chat-content">
            ...
            <div class="chat-box-content" v-show="currentConversation.id">
                <bc-messages-box :key="currentConversation.id" @click-load-more="doLoadMore" :messages="currentConversation.messages" :current="currentConversation" ref="messageDisplay"></bc-messages-box>
...
<script type="text/x-template" id="bc-messages-box">
