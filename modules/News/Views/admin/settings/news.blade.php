    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                ?>
                <div class="form-group">
                    <label class="" >{{__("Blog Style")}}</label>
                    <div class="form-controls">
                    <select class="form-control" name="blog_style">
                        <option @if(!empty($style_page) && $style_page == 'gird') selected @endif value="gird">{{__("Blog Grid")}}</option>
                        <option @if(!empty($style_page) && $style_page =='gird_sidebar') selected @endif value="gird_sidebar">{{__("Blog Grid Sidebar")}}</option>
                        <option @if(!empty($style_page) && $style_page =='detail') selected @endif value="detail">{{__("Blog Detail")}}</option>
                        <option @if(!empty($style_page) && $style_page =='list') selected @endif value="list">{{__("Blog List")}}</option>
                    </select>
                    </div>
                </div>
                @if(is_default_lang())
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Enable review system for new?")}}</label>
                        <div class="form-controls">
                            ...
                            <br>
                            <small class="form-text text-muted">{{__("Turn on the mode for reviewing new")}}</small>
                        </div>
                    </div>
