                    ...
                    @else
                        <div class="col-md-8">
                            @if($rows->count() > 0)
                                    ...
                                    @elseif($style_page == 'detail')
                                        <div class="main_blog_post_content">
                                            @include('News::frontend.layouts.details.news-list-detail')
                                        </div>
                                    @else
                                        <div class="main_blog_post_content">
                                            @foreach($rows as $row)
                                            @include('News::frontend.layouts.details.news-list')
                                            @endforeach
                                        </div>
                                    @endif
